...
<div class="responsive-container-block bigContainer">
    <div class="responsive-container-block Container">
        ...
        <p class="text-blk subHeading">
            Мы — группа студентов Тихоокеанского государственного университета (ТОГУ), объединенных общей страстью к программированию и образовательным технологиям.
            Наша цель — создать увлекательную и полезную образовательную платформу, которая поможет каждому освоить программирование, независимо от уровня подготовки.
        </p>
